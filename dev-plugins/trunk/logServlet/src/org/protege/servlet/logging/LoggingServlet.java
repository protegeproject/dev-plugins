package org.protege.servlet.logging;
...
public class LoggingServlet extends HttpServlet {
    ...
    public static final Level[] LEVELS = { Level.ALL, Level.FINEST, Level.FINER, Level.FINE, 
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (loggingPath != null) {
            currentLevel = getEffectiveLevel(logger);
        }
